    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Features"
                    heading="Built for modern brands & creators"
                    description="Our AI instantly produces professional lifestyle
                    imagery and short-form videos optimized for social media, e-commerce, and more. Focus on growth while we handle the creative execution."
                />
