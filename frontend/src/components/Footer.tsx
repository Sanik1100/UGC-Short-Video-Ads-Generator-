                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
                           Create viral UGC in seconds with our AI-powered platform. Transform your product shots into stunning images and videos that captivate your audience and drive sales. No design skills needed - just upload your assets and let our AI do the rest!
                        </p>
                    </div>
